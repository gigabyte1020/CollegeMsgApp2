...
public class SendQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RootRef= FirebaseDatabase.getInstance().getReference("Assignments");
...
//                BodyText=sendBody.getText().toString();
                StorageReference storageReference= FirebaseStorage.getInstance().getReference().child("Assignment Files");
...
//                                messageBodyDDetail.put(messageReceiverRef + "/" + messagePushID, messageDocsBody);
    ...
    private void Initialize() {
        sendTitle=findViewById(R.id.questionheading);
