...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagereceiverimage=getIntent().getExtras().get("groupname").toString();
...
//        Displaylastseen();
        ...
        RootRef.child("Groups1").child(currentGroupName).addChildEventListener(new ChildEventListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==555 && resultCode==RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            if(!checker.equals("image"))
            {
                ...
                final String messageSenderRef="Groups1/"+currentGroupName;
                final String messageReceiverRef="Groups1/"+currentGroupName; //???

                DatabaseReference Usermessagekeyref=RootRef.child("Groups1").child(currentGroupName).push();
...
//                            messageBodyDetails.put(messageReceiverRef+"/"+messagePushID,messageTextBody);
    ...
    private void SendMessage() {
        ...
        {
            String messageSenderRef="Groups1/"+currentGroupName;
            String messageReceiverRef="Groups1/"+currentGroupName;
